import svgPaths from "./svg-7bt78jcxm7";
import imgCharacterImage from "figma:asset/b0f397bb8e6ffd82d5c040d7af93c79e81a98946.png";
import imgImage from "figma:asset/da96cdeac20dd4e007079a284d88a667962046af.png";
import img from "figma:asset/7650acb3c38ea70d8a0e39ea56457dcc67fe5604.png";
import img1 from "figma:asset/08b93791cd58b9c902e2fa400c490c9f95481605.png";
import img2 from "figma:asset/e4a40955d23d726ecc4a4d5dc71ff08b3a7c5887.png";
import { imgTexture } from "./svg-u1yst";
...
function CharacterImage() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[156px] items-start relative rounded-[16px] shrink-0 w-full" data-name="Character Image">
      <img alt="" className="absolute inset-0 max-w-none mix-blend-screen object-50%-50% object-cover pointer-events-none rounded-[16px] size-full" src={imgCharacterImage} />
      <div className="basis-0 grow min-h-px min-w-px relative rounded-[16px] shrink-0 w-full" data-name="Image">
        <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid box-border inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[16px] size-full" src={imgImage} />
...
function BackgroundMask() {
  return (
    <div className="absolute contents inset-[1.667%]" data-name="Background Mask">
      <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px] mask-size-[32px_32px] mix-blend-hard-light" data-name="Texture" style={{ maskImage: `url('${imgTexture}')` }}>
      ...
      <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px] mask-size-[32px_32px]" data-name="Shading" style={{ maskImage: `url('${imgTexture}')` }}>
...
function CharacterCard() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[8px] h-[386px] items-center left-0 overflow-clip p-[16px] rounded-[16px] top-0 w-[276px]" data-name="Character Card">
        ...
        <div className="absolute inset-0" data-name="Plaque Style">
          ...
          <div className="absolute inset-[1.667%]" data-name="Plaque Border">
            ...
            <div className="absolute inset-[3.45%]" data-name="Outer Stroke Decoration">
              <img alt="" className="block max-w-none size-full" height="36" src={img2} width="36" />
            </div>
...
export default function CardTemplate() {
  return (
    <div className="relative size-full" data-name="Card Template">
      <CharacterCard />
    </div>
  );
}