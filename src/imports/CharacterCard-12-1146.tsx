import svgPaths from "./svg-3c350td5hr";
...
import img5 from "figma:asset/e4a40955d23d726ecc4a4d5dc71ff08b3a7c5887.png";
import { img2 } from "./svg-6arys";
...
export default function CharacterCard() {
  return (
    <div className="relative size-full" data-name="Character card">
      <div className="absolute box-border content-stretch flex flex-col gap-[8px] h-[386px] items-center left-0 overflow-clip p-[16px] rounded-[16px] top-0 w-[276px]" data-name="Character Card">
        ...
        <Name />
        <Abilities />
        <div className="absolute left-[228px] size-[40px] top-[8px]" data-name="VP tile">
          <div className="absolute inset-0" data-name="Plaque Style">
            <div className="absolute inset-[1.667%] shadow-[4px_4px_4px_0px_rgba(0,0,0,0.5)]" data-name="Background">
            ...
            <div className="absolute inset-[1.667%]" data-name="Plaque Border">
              ...
              <div className="absolute inset-[3.45%]" data-name="Outer Stroke Decoration">
                <img alt="" className="block max-w-none size-full" height="36" src={img5} width="36" />
              </div>
